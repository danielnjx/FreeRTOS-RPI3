 ...
 * \ingroup Tasks
 */
#define xTaskCreate( pvTaskCode, pcName, usStackDepth, pvParameters, uxPriority, pxCreatedTask, preempt ) xTaskGenericCreate( ( pvTaskCode ), ( pcName ), ( usStackDepth ), ( pvParameters ), ( uxPriority ), ( pxCreatedTask ), (preempt), ( NULL ), ( NULL ) )

/* Daniel */
#define xTaskCreatePre( pvTaskCode, pcName, usStackDepth, pvParameters, uxPriority, pxCreatedTask, preempt)
